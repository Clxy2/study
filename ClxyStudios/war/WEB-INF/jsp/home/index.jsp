...
<div class="col-md-12">
	<c:forEach begin="1" end="6" varStatus="status">
		<div class="row intro">
			<div class="col-md-7 section col-md-offset-${status.index%2==0?'3':'2'}">
				<img src="/resources/home/img/intro${status.index}.gif" class="${status.index%2==0?'pull-right':''}"/>
	...
	<div class="row intro" >
		<div class="col-md-offset-3 col-md-6 section text-center">
			<img src="/resources/home/img/intro8.gif" class="pull-left" />
			<spring:message code="home.intro7" />
			<img src="/resources/home/img/intro7.gif" class="pull-right" />
		</div>
	</div>
</div>
