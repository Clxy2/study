...
import cn.clxy.tools.swing.lua.LuaPanel;
import cn.clxy.tools.swing.memo.MemoPanel;
...
public class View extends FrameView {
    ...
    @Inject
    public void setMemoJPanel(MemoPanel memoJPanel) {
        // TODO 最终应该自动读取配置。Title，Icon，Class.
        // Icon icon = getResourceMap().getIcon("Memo.icon");
        tabPanel.addTab("Memo", null, memoJPanel);
    }

    @Inject
    public void setLuaJPanel(LuaPanel luaJPanel) {
        // TODO 最终应该自动读取配置。Title，Icon，Class.
        tabPanel.addTab("WOW", null, luaJPanel);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
                .getInstance(cn.clxy.tools.swing.App.class).getContext().getResourceMap(View.class);
        mainPanel.setBackground(resourceMap.getColor("mainPanel.background")); // NOI18N
        mainPanel.setFocusable(false);
        mainPanel.setName("mainPanel"); // NOI18N
        mainPanel.setLayout(new java.awt.BorderLayout());

        tabPanel.setForeground(resourceMap.getColor("tabPanel.foreground")); // NOI18N
        ...
        tabPanel.setFont(resourceMap.getFont("tabPanel.font")); // NOI18N
        ...
        statusPanelLayout
                .setHorizontalGroup(statusPanelLayout
                        ...
                        .addComponent(statusPanelSeparator, javax.swing.GroupLayout.DEFAULT_SIZE,
                                400, Short.MAX_VALUE)
                        .addGroup(
                                statusPanelLayout
