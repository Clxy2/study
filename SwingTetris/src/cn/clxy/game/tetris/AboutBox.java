...
public class AboutBox extends javax.swing.JDialog {
    ...
    static {
        ResourceMap res = SwingUtil.getResource(App.class, AboutBox.class);
        url1 = res.getString("Application.homepage1");
        url2 = res.getString("Application.homepage2");
    }
    ...
    private void initComponents() {
        ...
        appHomepageLabel1 = new UrlLabel(url1);
        javax.swing.JLabel appDescLabel = new javax.swing.JLabel();
        javax.swing.JLabel imageLabel = new javax.swing.JLabel();
        appHomepageLabel2 = new UrlLabel(url2);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(
                cn.clxy.game.tetris.App.class).getContext().getActionMap(AboutBox.class, this);
        ...
        layout.setVerticalGroup(layout.createParallelGroup(
                javax.swing.GroupLayout.Alignment.LEADING).addComponent(imageLabel,
                javax.swing.GroupLayout.PREFERRED_SIZE, 216, Short.MAX_VALUE).addGroup(
                layout.createSequentialGroup().addContainerGap().addComponent(appTitleLabel)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(appDescLabel).addPreferredGap(
                                javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(
                                layout.createParallelGroup(
                                        javax.swing.GroupLayout.Alignment.BASELINE).addComponent(
                                        versionLabel).addComponent(appVersionLabel))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(
                                layout.createParallelGroup(
                                        javax.swing.GroupLayout.Alignment.BASELINE).addComponent(
                                        vendorLabel).addComponent(appVendorLabel)).addPreferredGap(
                                javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(
                                layout.createParallelGroup(
                                        javax.swing.GroupLayout.Alignment.BASELINE).addComponent(
                                        homepageLabel).addComponent(appHomepageLabel1))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(appHomepageLabel2).addPreferredGap(
    ...
    private javax.swing.JLabel appHomepageLabel2;
    private javax.swing.JButton closeButton;

    // End of variables declaration//GEN-END:variables

    private static class UrlLabel extends JLabel {
            ...
            addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent evt) {
                    try {
                        ...
                        Desktop.getDesktop().browse(URI.create(l.getText()));
                    } catch (Exception e) {
                        // do nothing.
                    }
                }
